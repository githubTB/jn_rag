...
from services.prompt_templates.business_scale_extract_prompt_template import (
    SERVICE_NAME as BUSINESSINESS_SCALE_EXTRACT_MCP_SERVICE,
    q as BUSINESSINESS_SCALE_EXTRACT_MCP_Q,
    system_prompt as BUSINESSINESS_SCALE_EXTRACT_MCP_SYSTEM_PROMPT,
    user_prompt as BUSINESSINESS_SCALE_EXTRACT_MCP_USER_PROMPT,
)
from services.prompt_templates.process_flow_extract_prompt_template import (
...
from services.prompt_templates.regulation_policy_extract_prompt_template import (
...
from services.prompt_templates.transformer_efficiency_benchmark_extract_prompt_template import (
...
from services.prompt_templates.air_compressor_efficiency_benchmark_extract_prompt_template import (
...
_SERVICES: dict[str, MCPService] = {
    ...
    BUSINESSINESS_SCALE_EXTRACT_MCP_SERVICE: MCPService(
        name=BUSINESSINESS_SCALE_EXTRACT_MCP_SERVICE,
        q=BUSINESSINESS_SCALE_EXTRACT_MCP_Q,
        system_prompt=BUSINESSINESS_SCALE_EXTRACT_MCP_SYSTEM_PROMPT,
        user_prompt=BUSINESSINESS_SCALE_EXTRACT_MCP_USER_PROMPT,
    ),
